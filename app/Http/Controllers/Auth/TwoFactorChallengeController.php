    ...
    public function store(Request $request)
    {
        ...
        if ($request->filled('code')) {
            ...
            if (! $g2fa->verifyKey($secret, $request->input('code'))) {
                throw ValidationException::withMessages(['code' => __('Ongeldige verificatiecode.')]);
            }
            ...
            if (! $matched) {
                throw ValidationException::withMessages(['recovery_code' => __('Ongeldige backup-code.')]);
            }
            // Remove used code
            ...
            throw ValidationException::withMessages(['code' => __('Vul een code in.')]);
        }
