...
class BrandDesignService
{
    ...
    public function propose(Company $company, array $answers): array
    {
        ...
        foreach (array_slice((array) ($json['directions'] ?? []), 0, 3) as $d) {
            ...
            $directions[] = [
                'name' => mb_substr(trim((string) ($d['name'] ?? 'Richting')), 0, 40),
                'brand_color' => $brand,
        ...
        if ($directions === []) {
            throw new \DomainException('Er kwam geen bruikbaar voorstel terug. Probeer het opnieuw met iets meer toelichting.');
        }
    ...
    private function schema(): array
    {
        ...
        $direction = [
            ...
            'properties' => [
                ...
                'tagline' => ['type' => 'string', 'description' => 'Pakkende Nederlandse slogan van maximaal tien woorden, zonder aanhalingstekens.'],
                ...
                'motivation' => ['type' => 'string', 'description' => 'Eén Nederlandse zin: waarom deze richting bij dit bedrijf past.'],
            ],
    ...
    private function prompt(Company $company, array $answers): string
    {
        ...
        return implode("\n", [
            'Je bent merkontwerper voor kleine Nederlandse ondernemers. Ontwerp precies drie duidelijk verschillende huisstijlrichtingen voor dit bedrijf (bijvoorbeeld warm/ambachtelijk, strak/zakelijk, fris/modern).',
            ...
            '',
            'Regels: de hoofdkleur moet werken op facturen, knoppen en een website; de accentkleur is donker en leesbaar als tekstkleur; taglines in het Nederlands; logo_text bij een monogram 1–3 hoofdletters, bij een woordmerk de bedrijfsnaam of een korte variant.',
        ]);
    }
}
