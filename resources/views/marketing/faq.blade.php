...
@php
  ...
  $faqGroups = [
    'Algemeen' => [
      ['Wat is EasyInvoice?', "EasyInvoice is eenvoudige facturatiesoftware voor Nederlandse ZZP'ers en het MKB. Je maakt facturen, beheert klanten, houdt je BTW bij en verstuurt herinneringen — alles op één plek."],
    ...
    'Prijs & abonnement' => [
      ['Wat kost EasyInvoice?', 'Er zijn twee abonnementen: <b>Basis</b> voor € 12,10 per maand (incl. 21% btw) met het volledige facturatiepakket, en <b>Slim</b> voor € 21,18 per maand (incl. btw) met daarbovenop de AI-functies — bonnen en inkoopfacturen automatisch herkennen, en offertes uit tekst. Geen verborgen kosten, maandelijks opzegbaar.'],
      ['Kan ik op elk moment opzeggen?', 'Ja, EasyInvoice is maandelijks opzegbaar. Geen contracten of jaarverplichtingen. Je facturen blijven altijd downloadbaar.'],
      ['Is er een gratis proefperiode?', 'Ja, je probeert EasyInvoice 14 dagen gratis. Geen creditcard nodig om te starten.'],
    ],
    'Facturen & BTW' => [
      ...
      ['Wat als ik onder de KOR-regeling val?', 'EasyInvoice ondersteunt de Kleine Ondernemersregeling volledig — je verstuurt facturen zonder BTW, met automatische vermelding van de KOR-regeling.'],
    ...
    'Samenwerken & klantenportaal' => [
      ["Kunnen collega's ook in EasyInvoice werken?", "Ja, en extra gebruikers kosten niets. Nodig collega's uit via Instellingen → Team en kies per persoon een rol: beheerder (alles), medewerker (het dagelijkse werk, zonder instellingen en rapporten) of boekhouder (alles inzien, niets wijzigen)."],
