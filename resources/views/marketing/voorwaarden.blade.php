...
<section class="legal">
  <div class="container">
    ...
    <p>Er zijn twee abonnementen: Basis voor € 12,10 per maand en Slim voor € 21,18 per maand (beide inclusief 21% btw). Na het afsluiten wordt het abonnement automatisch elke 30 dagen verlengd en geïncasseerd, totdat je opzegt. Betaling verloopt veilig via onze betaalprovider Stripe; wij bewaren geen volledige kaartgegevens.</p>
