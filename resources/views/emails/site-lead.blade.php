...
<body style="margin:0;padding:24px;background:#f5f5f4;font-family:Inter,Arial,Helvetica,sans-serif;color:#1c1917;">
  <div style="max-width:560px;margin:0 auto;background:#fff;border-radius:12px;padding:28px;border:1px solid #e7e5e4;">
    ...
    <table style="border-collapse:collapse;font-size:14px;width:100%;">
      ...
      <tr><td style="padding:6px 0;color:#78716c;">E-mail</td><td style="padding:6px 0;"><a href="mailto:{{ $lead->email }}" style="color:#E8231F;">{{ $lead->email }}</a></td></tr>
    ...
    <p style="margin:20px 0 0;font-size:13px;color:#78716c;">Beantwoord deze mail om direct te reageren. Alle berichten staan ook onder Instellingen → Website in EasyInvoice.</p>
  </div>
</body>
</html>
