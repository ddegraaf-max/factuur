...
<table class="totals">
  <tr><td class="label">{{ __('doc.subtotal') }}</td><td class="value">{{ money($pdfSign * $invoice->subtotal) }}</td></tr>
  ...
  @if($pdfAdvances->isNotEmpty())
    ...
    @endforeach
    <tr class="grand-row"><td>{{ __($invoice->is_credit ? 'doc.amount_credited' : 'doc.amount_due') }}</td><td class="value brand">{{ money($pdfSign * $pdfPayable) }}</td></tr>
  @else
    <tr class="grand-row"><td>{{ __($invoice->is_credit ? 'doc.amount_credited' : 'doc.amount_due') }}</td><td class="value brand">{{ money($pdfSign * $invoice->total) }}</td></tr>
  @endif
</table>
