...
@section('description', 'Przenieś klientów, produkty i nieopłacone faktury z ' . $pkg['name'] . ' do ' . brand('name') . ': eksport CSV lub XLSX, import z automatycznym rozpoznaniem kolumn (NIP, nazwa, termin płatności, brutto), bez duplikatów. Faktury gotowe do KSeF, marka, strona www i windykacja z Creditline Polska.')
