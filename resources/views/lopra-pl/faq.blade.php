...
{{-- Najczęstsze pytania — Lopra Polska (APP_BRAND=lopra_pl). Treść spójna ze stroną główną: KSeF, biała lista, VAT, import, marka, windykacja własna i sprzedaż faktur do sprzedamfakture.pl, cennik 49/79 zł netto. --}}

@section('title', 'Najczęstsze pytania — ' . brand('name'))
@section('description', 'Odpowiedzi na najczęstsze pytania o ' . brand('name') . ': KSeF, NIP i biała lista, stawki VAT, import z Fakturowni, iFirmy, wFirmy i inFaktu, marka i strona www, windykacja i sprzedaż faktur do sprzedamfakture.pl, cennik i bezpieczeństwo danych.')
...
@php
  ...
  $faqGroups = [
    ...
    'Windykacja i sprzedaż faktur' => [
      ['Co się dzieje, gdy klient nie płaci?', 'Najpierw ' . brand('name') . ' wysyła w Twoim imieniu przypomnienia i ponaglenia (e-mail, SMS) z linkiem do zapłaty BLIK-iem lub Przelewy24. Jeśli to nie działa, jednym kliknięciem tworzysz formalne wezwanie do zapłaty (PDF) z odsetkami ustawowymi za opóźnienie i rekompensatą 40/70/100 EUR. Potem wybierasz: dochodzisz należności sam (także na drodze sądowej) albo sprzedajesz fakturę do sprzedamfakture.pl — jednym kliknięciem, z danymi prosto z faktury, bez przepisywania.'],
      ['Ile kosztuje windykacja i sprzedaż faktury?', 'Przypomnienia, ponaglenia, wezwanie do zapłaty i kalkulator odsetek są w cenie abonamentu. Sprzedaż faktury nie wiąże się z żadnymi opłatami: sprzedamfakture.pl przedstawia <b>ofertę z ceną wykupu, zanim podejmiesz decyzję</b> — bez prowizji i opłat wstępnych. Odsetki ustawowe i rekompensata, które naliczasz w wezwaniu, obciążają dłużnika na podstawie ustawy o przeciwdziałaniu nadmiernym opóźnieniom w transakcjach handlowych. Zawsze wiesz, ile dostaniesz, zanim sprzedasz.'],
      ['Czy mogę sprzedać niezapłaconą fakturę?', 'Tak. Jeśli nie chcesz czekać na zapłatę ani iść do sądu, zgłoś fakturę do wykupu prosto z ' . brand('name') . '. sprzedamfakture.pl przygotuje ofertę cesji w <b>jeden dzień roboczy</b>; po jej akceptacji pieniądze trafiają na Twoje konto, a ryzyko i dalsze odzyskiwanie należności bierze na siebie kupujący. Decyzja zawsze należy do Ciebie.'],
      ['Czy mogę sprzedać stary wyrok albo nakaz zapłaty?', 'Tak. sprzedamfakture.pl wykupuje także wierzytelności stwierdzone tytułem wykonawczym — prawomocnym wyrokiem lub nakazem zapłaty — również wtedy, gdy egzekucja została już umorzona jako bezskuteczna. Cena to zazwyczaj <b>10–40% wartości nominalnej</b>, zależnie od jakości tytułu i profilu dłużnika, po ocenie każdej sprawy; małe portfele i pojedyncze tytuły też są mile widziane. Szczegóły i formularz zgłoszenia znajdziesz na stronie <a href="' . route('pl.skup-wyrokow') . '">skupu starych wyroków</a>.'],
    ...
    'Cennik & bezpieczeństwo' => [
      ['Ile kosztuje ' . brand('name') . ' po okresie próbnym?', '<b>Podstawowy</b>: 49 zł netto (60,27 zł brutto) miesięcznie — faktury bez limitu, KSeF, VAT, wizytówka, strona www i windykacja własna ze sprzedażą faktur. <b>Smart</b>: 79 zł netto (97,17 zł brutto) miesięcznie — wszystko z Podstawowego plus identyfikacja wizualna z AI, tekst strony www z AI, koszty ze zdjęcia, oferta z tekstu i priorytetowa wycena wykupu faktur. Bez ukrytych opłat i limitów klientów.'],
