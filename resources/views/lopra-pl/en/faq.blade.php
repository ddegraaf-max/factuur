...
{{-- Frequently asked questions — Lopra Polska (APP_BRAND=lopra_pl), English edition. Content consistent with the landing page: KSeF, white list, VAT, import, brand, debt collection with sprzedamfakture.pl, pricing 49/79 zł net. --}}

@section('title', 'Frequently asked questions — ' . brand('name'))
@section('description', 'Answers to the most common questions about ' . brand('name') . ': KSeF, NIP and the VAT white list, VAT rates, import from Fakturownia, iFirma, wFirma and inFakt, brand and website, debt collection with sprzedamfakture.pl, pricing and data security.')
...
@php
  ...
  $faqGroups = [
    'Getting started & account' => [
      ['What is ' . brand('name') . ' and who is it for?', brand('name') . ' is one tool for businesses in Poland: invoices ready for KSeF (the national e-invoicing system), quotes, VAT settlement, a visual identity, a digital business card and a website — plus debt collection with sprzedamfakture.pl when a client does not pay. It suits sole traders, sp. z o.o. companies and small firms with a few people. No accounting knowledge needed: everything is explained in plain language, without jargon.'],
    ...
    'Debt collection with sprzedamfakture.pl' => [
      ['What happens when a client does not pay?', 'First, ' . brand('name') . ' sends reminders and dunning notices on your behalf (e-mail, SMS) with a link to pay by BLIK or Przelewy24. If that does not work, one click creates a formal wezwanie do zapłaty (payment demand) as a PDF, with statutory interest for late payment and the 40/70/100 EUR recovery compensation. The final step is handing the case to sprzedamfakture.pl — with a complete file built from your invoice, no retyping of data.'],
      ['How much does debt collection with sprzedamfakture.pl cost?', 'Reminders, dunning notices and the payment demand are included in your subscription. Handing a case to sprzedamfakture.pl is <b>quoted before you commission it</b> — no upfront fees; as a rule, collection costs and interest are charged to the debtor under the Act on Counteracting Excessive Delays in Commercial Transactions. You always know what you are signing up for before you hand over a case.'],
      ['Can I sell an unpaid invoice?', 'Yes. If you need cash now, submit the receivable for purchase straight from the invoice. sprzedamfakture.pl will prepare an assignment offer within <b>one working day</b>. The decision is always yours.'],
    ...
    'Pricing & security' => [
      ['How much does ' . brand('name') . ' cost after the trial?', '<b>Podstawowy</b>: 49 zł net (60.27 zł gross) per month — unlimited invoices, KSeF, VAT, business card, website and debt collection steps 1–2. <b>Smart</b>: 79 zł net (97.17 zł gross) per month — everything in Podstawowy plus an AI visual identity, AI website copy, expenses from a photo, quotes from text and priority handling of collection cases. No hidden fees, no client limits.'],
