...
{{-- Frequently asked questions — Lopra Polska (APP_BRAND=lopra_pl), English edition. Content consistent with the landing page: KSeF, white list, VAT, import, brand, debt collection with Creditline Polska, pricing 49/79 zł net. --}}

@section('title', 'Frequently asked questions — ' . brand('name'))
@section('description', 'Answers to the most common questions about ' . brand('name') . ': KSeF, NIP and the VAT white list, VAT rates, import from Fakturownia, iFirma, wFirma and inFakt, brand and website, debt collection with Creditline Polska, pricing and data security.')
...
@php
  ...
  $faqGroups = [
    ...
    'Debt collection with Creditline Polska' => [
      ['What happens when a client does not pay?', 'First, ' . brand('name') . ' sends reminders and dunning notices on your behalf (e-mail, SMS) with a link to pay by BLIK or Przelewy24. If that does not work, one click creates a formal wezwanie do zapłaty (payment demand) as a PDF, with statutory interest for late payment and the 40/70/100 EUR recovery compensation. The final step is handing the case to Creditline Polska — with a complete file built from your invoice, no retyping of data.'],
      ['How much does debt collection with Creditline Polska cost?', 'Reminders, dunning notices and the payment demand are included in your subscription. Handing a case to Creditline Polska is <b>quoted before you commission it</b> — no upfront fees; as a rule, collection costs and interest are charged to the debtor under the Act on Counteracting Excessive Delays in Commercial Transactions. You always know what you are signing up for before you hand over a case.'],
      ['Can I sell an unpaid invoice?', 'Yes. If you need cash now, submit the receivable for purchase straight from the invoice. Creditline Polska will prepare an assignment offer within <b>one working day</b>. The decision is always yours.'],
