...
@php
  ...
  $faqGroups = [
    ...
    'Collection toolkit and selling invoices' => [
      ...
      ['Can I sell an old judgment or payment order?', 'Yes. sprzedamfakture.pl also buys claims confirmed by an enforceable title (tytuł wykonawczy) — a final judgment or payment order — even when a previous enforcement came back empty. Prices are typically <b>10–40% of the nominal value</b>, depending on title quality and debtor profile, after a per-file assessment. Describe your judgment on the page <a href="' . route('pl.skup-wyrokow') . '">We buy old judgments</a> and you will receive an offer within a few working days.'],
