      ...
      <div class="calc-card">
        ...
        <div class="m-row-2">
          ...
          <div class="m-field">
            ...
            <div class="calc-hint">Puste pole = stopa ustawowa dla każdego okresu automatycznie (stopa referencyjna NBP + 10 p.p., ogłaszana co pół roku; obecnie {{ $ratePct }}%). Wpisz własną wartość, jeśli chcesz liczyć inaczej.</div>
          </div>
        </div>
      </div>
      ...
      <div class="calc-card">
        ...
        <div class="calc-result">
          ...
          <table>
            ...
            <tr><td>Rekompensata za koszty odzyskiwania<small>art. 10 ustawy · <span id="outEur">40</span> EUR × <span id="outKurs">{{ number_format($eurPln, 4, ',', ' ') }}</span> zł · <span id="outKursNbp" hidden>kurs NBP z <span id="outKursData"></span></span><span id="outKursEst">kurs orientacyjny</span></small></td><td class="r" id="outRek">0,00 zł</td></tr>
        ...
        <div class="calc-note">Kalkulator ma charakter pomocniczy. Rekompensatę przelicza się według średniego kursu euro NBP z ostatniego dnia roboczego miesiąca poprzedzającego miesiąc wymagalności — kalkulator pobiera ten kurs z NBP dla wpisanego terminu płatności (gdy NBP jest niedostępny, przyjmuje kurs orientacyjny {{ number_format($eurPln, 2, ',', ' ') }} zł). Kwoty odsetek zaokrąglamy do pełnych groszy.</div>
